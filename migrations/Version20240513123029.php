 ...
 */
final class Version20240513123029 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chevre_groupe_traitement DROP CONSTRAINT fk_9a8717ea92f637e3');
        $this->addSql('ALTER TABLE chevre_groupe_traitement ADD CONSTRAINT fk_9a8717ea92f637e3 FOREIGN KEY (chevre_id) REFERENCES chevre (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
}
